const es: Record<string, string> = {
  ...
  "app.credit": "Un proyecto de clase de 9.º grado por Easton Brown y Dray Montoya",
  ...
  "results.combo": "Un {primary} con un toque de {secondary} — combinando {primaryStrength} con {secondaryStrength}.",
  "results.whoYouAre": "Quién Eres",
  "results.actionPlan": "Tu Plan de Acción",
  "results.careerPaths": "Carreras Futuras",
  "results.alignedCareerPaths": "Carreras Alineadas",
  ...
  "poster.subtitle": "Vista previa virtual del trifold de la feria de ciencias. Panel 1 (ala izquierda), Panel 2 (centro), Panel 3 (ala derecha).",
  ...
  "dashboard.aptitudeByAge": "Mezcla de Aptitudes por Nivel Escolar",
  "dashboard.aptitudeByAgeDesc": "Las barras apiladas muestran cómo las respuestas de cada nivel escolar se distribuyen entre los seis perfiles inspirados en RIASEC.",
  "dashboard.waitingTitle": "Listo para el primer estudiante",
  "dashboard.waitingDesc": "Una vez que alguien termine la encuesta, su aptitud principal aparecerá aquí. El panel se actualiza solo — déjalo corriendo.",
  "dashboard.aptitudeDistribution": "Ranking de Aptitudes",
  "dashboard.aptitudeRadar": "Radar de Aptitudes",
